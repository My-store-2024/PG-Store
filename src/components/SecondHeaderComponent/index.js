...
//       <TouchableOpacity style={styles.backArrow} onPress={openDrawer}>
...
//       {type === 'Visible' && (
//         <Image style={styles.userLogo} source={Images.ProfilePic} />
//       )}
...
//       >
//         <Image style={styles.iconSize} source={Images.searchIcon} />
//       </TouchableOpacity>
...
//       >
//         <Image style={styles.iconSize} source={Images.bellIcon} />
//       </TouchableOpacity>

//       <TouchableOpacity onPress={() => navigation.navigate('AccountScreen')}>
//         {searchType === 'RoomSearch' && (
//           <Image style={styles.userLogo} source={Images.searchIcon} />
//         )}
//       </TouchableOpacity>
//     </View>
//   );
